      ...
      <AnimatePresence mode="wait">
        <Routes>
          ...
          <Route
            ...
            path="/user/shops"
            element={
              <ProtectedRoute isAllowed={storeS} redirectTo={"/"}>
                <motion.div
                  key="listShops"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
          ...
          <Route
            exact
            path="/shop/:idShop/addproduct"
            element={
              <ProtectedRoute isAllowed={storeS} redirectTo={"/user/shops"}>
                <motion.div
                  key="addProduct"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
